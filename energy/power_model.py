...
def propulsion_power(vessel_speed: float) -> float:
    vessel_speed = 0.514444*vessel_speed
    return (383.82 + 5.52*vessel_speed + 3.63*vessel_speed**2 + 1.65*vessel_speed**3)*1000
